...
export class DataSetService {
    ...
    saveDataSet(dataSet: DataSet): Observable<DataSet> {
      ...
      return this._http.post(env.contextPath + '/api/datasets', dataSet, options)
        .map(response => response.json() as DataSet);
    }
