...
@Component({
    ...
    styleUrls: ['./editor-instancevariable-search.component.css']
})
export class EditorInstanceVariableSearchComponent implements OnInit {
    ...
    ngOnInit() {
        this.route.queryParams.subscribe(params => {
            ...
            this.maxResults = Number(params['max'] || EditorInstanceVariableSearchComponent.defaultMaxResults);
