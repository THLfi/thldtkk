...
@Component({
    templateUrl: './editor-variable-view.component.html'
})
export class EditorVariableViewComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.variableService.getInstanceVariables(variableId, 'editor')
