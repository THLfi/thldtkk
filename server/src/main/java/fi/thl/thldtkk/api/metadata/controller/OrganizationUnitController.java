...
public class OrganizationUnitController {
    ...
    private final String organizationUnitsPath = "/types/OrganizationUnit/nodes";
    ...
    public JsonArray query(
        ...
        String url = fromPath(organizationUnitsPath)
    ...
    public JsonObject get(@PathVariable("id") UUID id) {
        String url = fromPath(organizationUnitsPath).path("/" + id.toString()).toUriString();
    ...
    public JsonObject post(@RequestBody JsonObject dataset) {
        String url = fromPath(organizationUnitsPath).toUriString();
