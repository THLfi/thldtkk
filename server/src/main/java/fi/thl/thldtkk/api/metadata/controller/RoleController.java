...
public class RoleController {
    ...
    private final String rolesPath = "/types/Role/nodes";
    ...
    public JsonObject get(@PathVariable("id") UUID id) {
        String url = fromPath(rolesPath).path("/" + id.toString()).toUriString();
    ...
    public JsonObject post(@RequestBody JsonObject dataset) {
        String url = fromPath(rolesPath).toUriString();
